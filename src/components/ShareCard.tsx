...
const ShareCard = ({ result }: ShareCardProps) => {
  ...
  const warningText =
    result.verdict === "likely_fake"
      ...
      ? "❓ This article could not be verified"
      : result.verdict === "future_planned"
      ? "🕐 This article references a future or planned event"
      : result.verdict === "likely_real"
      ? "⚡ This article appears likely real"
      : "✅ This article has been verified as credible";
